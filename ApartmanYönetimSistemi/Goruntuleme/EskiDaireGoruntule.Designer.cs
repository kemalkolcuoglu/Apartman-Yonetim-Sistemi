namespace ApartmanYönetimSistemi.Goruntuleme
{
	partial class EskiDaireGoruntule
	{
		...
		private void InitializeComponent()
		{
			...
			this.gb_filtrele.Location = new System.Drawing.Point(12, 73);
			...
			this.gb_islemler.Location = new System.Drawing.Point(12, 240);
			this.gb_islemler.Name = "gb_islemler";
			this.gb_islemler.Size = new System.Drawing.Size(113, 218);
			...
			this.bt_sil.Text = "Daire Kaydını Sil";
			...
			this.bt_duzenle.Text = "Daire Kaydını Düzenle";
			...
			this.bt_daireEkle.Text = "Daire Kaydı Ekle";
			...
			this.Text = "Eski Daire Kayıtlarını Görüntüle - KKY Site Yönetim Sistemi";
