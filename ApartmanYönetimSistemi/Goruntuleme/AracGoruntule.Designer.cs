namespace ApartmanYönetimSistemi.Goruntuleme
{
	partial class AracGoruntule
	{
		...
		private void InitializeComponent()
		{
			...
			this.bt_aracEkle = new System.Windows.Forms.Button();
			this.gb_filtrele = new System.Windows.Forms.GroupBox();
			this.rb_model = new System.Windows.Forms.RadioButton();
			this.rb_marka = new System.Windows.Forms.RadioButton();
			this.rb_plaka = new System.Windows.Forms.RadioButton();
			...
			this.gb_islemler.Controls.Add(this.bt_aracEkle);
			...
			this.gb_islemler.Size = new System.Drawing.Size(113, 214);
			...
			this.bt_duzenle.Text = "Aracı Düzenle";
			this.bt_duzenle.UseVisualStyleBackColor = false;
			this.bt_duzenle.Click += new System.EventHandler(this.bt_duzenle_Click);
			// 
			// bt_aracEkle
			// 
			this.bt_aracEkle.BackColor = System.Drawing.SystemColors.ActiveCaption;
			this.bt_aracEkle.ForeColor = System.Drawing.Color.MidnightBlue;
			this.bt_aracEkle.Location = new System.Drawing.Point(6, 19);
			this.bt_aracEkle.Name = "bt_aracEkle";
			this.bt_aracEkle.Size = new System.Drawing.Size(101, 43);
			this.bt_aracEkle.TabIndex = 6;
			this.bt_aracEkle.Text = "Araç Ekle";
			this.bt_aracEkle.UseVisualStyleBackColor = false;
			this.bt_aracEkle.Click += new System.EventHandler(this.bt_aracEkle_Click);
			// 
			// gb_filtrele
			// 
			this.gb_filtrele.Controls.Add(this.rb_model);
			this.gb_filtrele.Controls.Add(this.rb_marka);
			this.gb_filtrele.Controls.Add(this.rb_plaka);
			...
			this.gb_filtrele.Location = new System.Drawing.Point(12, 48);
			this.gb_filtrele.Name = "gb_filtrele";
			this.gb_filtrele.Size = new System.Drawing.Size(113, 164);
			...
			this.rb_model.Location = new System.Drawing.Point(6, 65);
			this.rb_model.Name = "rb_model";
			this.rb_model.Size = new System.Drawing.Size(59, 17);
			this.rb_model.TabIndex = 3;
			this.rb_model.TabStop = true;
			this.rb_model.Tag = "Model";
			this.rb_model.Text = "Model";
			this.rb_model.UseVisualStyleBackColor = true;
			this.rb_model.CheckedChanged += new System.EventHandler(this.rb_CheckedChanged);
			// 
			// rb_marka
			// 
			this.rb_marka.AutoSize = true;
			this.rb_marka.Location = new System.Drawing.Point(6, 42);
			this.rb_marka.Name = "rb_marka";
			this.rb_marka.Size = new System.Drawing.Size(60, 17);
			this.rb_marka.TabIndex = 2;
			this.rb_marka.TabStop = true;
			this.rb_marka.Tag = "Marka";
			this.rb_marka.Text = "Marka";
			this.rb_marka.UseVisualStyleBackColor = true;
			this.rb_marka.CheckedChanged += new System.EventHandler(this.rb_CheckedChanged);
			// 
			// rb_plaka
			// 
			this.rb_plaka.AutoSize = true;
			this.rb_plaka.Location = new System.Drawing.Point(6, 19);
			this.rb_plaka.Name = "rb_plaka";
			this.rb_plaka.Size = new System.Drawing.Size(57, 17);
			this.rb_plaka.TabIndex = 1;
			this.rb_plaka.TabStop = true;
			this.rb_plaka.Tag = "AracPlaka";
			this.rb_plaka.Text = "Plaka";
			this.rb_plaka.UseVisualStyleBackColor = true;
			this.rb_plaka.CheckedChanged += new System.EventHandler(this.rb_CheckedChanged);
			// 
			// textBox1
			// 
			...
			this.Text = "Taşıtları Görüntüle - KKY Site Yönetim Sistemi";
			this.Resize += new System.EventHandler(this.AracGoruntule_Resize);
		...
		private System.Windows.Forms.Button bt_aracEkle;
		private System.Windows.Forms.GroupBox gb_filtrele;
		private System.Windows.Forms.RadioButton rb_model;
		private System.Windows.Forms.RadioButton rb_marka;
		private System.Windows.Forms.RadioButton rb_plaka;
