namespace ApartmanYönetimSistemi.Goruntuleme
{
	partial class YakitGoruntule
	{
		...
		private void InitializeComponent()
		{
			...
			this.bt_yakitEkle = new System.Windows.Forms.Button();
			...
			this.gb_islemler.Controls.Add(this.bt_yakitEkle);
			...
			this.gb_islemler.Location = new System.Drawing.Point(12, 192);
			this.gb_islemler.Name = "gb_islemler";
			this.gb_islemler.Size = new System.Drawing.Size(113, 263);
			this.gb_islemler.TabIndex = 8;
			...
			this.bt_sil.Text = "Yakıt Girdisini Sil";
			...
			this.bt_duzenle.Text = "Yakıt Girdisini Düzenle";
			this.bt_duzenle.UseVisualStyleBackColor = false;
			this.bt_duzenle.Click += new System.EventHandler(this.bt_duzenle_Click);
			// 
			// bt_yakitEkle
			// 
			this.bt_yakitEkle.BackColor = System.Drawing.SystemColors.ActiveCaption;
			this.bt_yakitEkle.ForeColor = System.Drawing.Color.MidnightBlue;
			this.bt_yakitEkle.Location = new System.Drawing.Point(6, 19);
			this.bt_yakitEkle.Name = "bt_yakitEkle";
			this.bt_yakitEkle.Size = new System.Drawing.Size(101, 43);
			this.bt_yakitEkle.TabIndex = 5;
			this.bt_yakitEkle.Text = "Yakıt Girdisi Ekle";
			this.bt_yakitEkle.UseVisualStyleBackColor = false;
			this.bt_yakitEkle.Click += new System.EventHandler(this.bt_yakitEkle_Click);
			// 
			// gb_filtrele
			// 
			...
			this.gb_filtrele.Size = new System.Drawing.Size(113, 137);
			this.gb_filtrele.TabIndex = 7;
			...
			this.dataGridView1.Size = new System.Drawing.Size(600, 443);
			...
			this.label1.Text = "Yakıt Girdileri";
			...
			this.bt_toplamTutar.Click += new System.EventHandler(this.bt_toplamTutar_Click);
			// 
			// YakitGoruntule
			// 
			...
			this.Name = "YakitGoruntule";
			this.Text = "Yakıt Girdilerini Görüntüle - KKY Site Yönetim Sistemi";
			this.Resize += new System.EventHandler(this.YakitGoruntule_Resize);
		...
		private System.Windows.Forms.Button bt_yakitEkle;
